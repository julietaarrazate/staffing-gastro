...
- **Contenido:** 17 routers, 14 modelos, 33 migraciones, 512 tests.
- **Tecnología:** FastAPI, SQLAlchemy (async), Alembic, Pydantic, Python 3.11.
- **Tamaño:** ~19.100 líneas de código (sin entornos virtuales ni caché).
...
- **Contenido:** 31 páginas, 107 componentes, 56 módulos de utilidades, 111 tests E2E.
- **Tecnología:** Next.js, React, TypeScript, TailwindCSS, MapLibre GL.
- **Tamaño:** ~25.700 líneas de código.
- **Despliegue real:** Vercel (https://oido.com.ar).
...
- **Tecnología:** Alembic + SQLAlchemy declarativo; PostgreSQL en producción.

#### 4. Documentación de arquitectura y decisiones
- **Ubicación:** `/docs`
- **Contenido:** documentación viva de producto, dominio, arquitectura, diseño y seguridad, más 15 Architecture Decision Records.
...
FRONTEND WEB (PWA)
   ...
   API REST + WebSocket (FastAPI, monolito modular DDD/hexagonal en 17 módulos)
        ↓
   Base de datos relacional (PostgreSQL gestionado)
```
...
4. El backend persiste datos en PostgreSQL.
