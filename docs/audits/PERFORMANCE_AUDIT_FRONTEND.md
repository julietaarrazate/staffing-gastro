...
> MapLibre GL vía `@vis.gl/react-maplibre` (ver [MAPS_REDESIGN.md](../reference/MAPS_REDESIGN.md),
...
`docs/audits/PERFORMANCE_REPORT.md §3.2` (previa a la migración a MapLibre) decía
