...
módulo" esperables). Confirma lo que ya decía `docs/audits/AUDIT_REPORT.md §5`:
...
- **Severidad:** 🟢 Baja — no es una vulnerabilidad (no expone datos, sólo
  ...
  de `docs/reference/SECURITY.md`/`03_SECURITY.md` como decisión consciente — hoy es
...
Coherente con `docs/foundation/PRINCIPLES.md` #10 (no introducir infraestructura sin
...
`ws_manager.py` (conexiones WebSocket en memoria) — `docs/reference/SECURITY.md` y
`docs/audits/SCALABILITY_REPORT.md` ya identifican ese techo para esos dos
