...
`docs/foundation/PRINCIPLES.md` #2 ("sensación nativa, no una web"). Se documenta acá
...
`https://staffya.com.ar` (documentado a propósito en `docs/reference/DEPLOY.md
...
`docs/audits/AUDIT_REPORT.md` (hace más de un mes) medía `aria-*` en 13 de 56
