...
> `docs/reference/SECURITY.md` (diseño vigente, mantenido) y `docs/audits/SECURITY_REPORT.md`
...
`docs/audits/SECURITY_REPORT.md` (2026-07-02) calificó el área en **62/100**, con
...
descuido. `docs/reference/SECURITY.md §Endurecimiento ya aplicado` ya lo registra;
...
ADR, ya documentado como tal en `docs/reference/SECURITY.md`.
...
tal en `docs/audits/SECURITY_REPORT.md` hallazgo #3 (fila de la tabla). Se
...
- Password: `min_length=8, max_length=128` (`identity/api/schemas.py:29,69`
  ...
  explicitada en `docs/reference/SECURITY.md`.
