...
> No reemplaza [SECURITY.md](../reference/SECURITY.md) (que describe el diseño vigente);
...
- **Password:** `RegisterRequest.password: str = Field(min_length=8,
  ...
  explícita y no un olvido — no está mencionada en `docs/reference/SECURITY.md`.
