...
> Amplía [ARCHITECTURE.md](../foundation/ARCHITECTURE.md#eventos) y
...
requiere un **ADR** (ver [PRINCIPLES.md](../foundation/PRINCIPLES.md) y
...
> [ARCHITECTURE.md](../foundation/ARCHITECTURE.md#eventos) y registrar el **ADR**.
