...
| Método | Ruta | Qué hace |
|--------|------|----------|
| GET | `/stats` | Métricas de la plataforma (usa la tabla completa de usuarios; no pagina — ver P5 en [PERFORMANCE_REPORT.md](../audits/PERFORMANCE_REPORT.md), fuera de alcance de R2.1) |
...
**R2.1** (`docs/planning/ROADMAP_IMPLEMENTATION.md`). Los listados largos marcados
...
- **`GET /admin/stats`** es la única excepción que no pagina: necesita el
  ...
  [PERFORMANCE_REPORT.md](../audits/PERFORMANCE_REPORT.md), no resuelto en R2.1).
...
Ver [ARCHITECTURE.md](../foundation/ARCHITECTURE.md#tiempo-real-websockets).
...
>   (P5 de [PERFORMANCE_REPORT.md](../audits/PERFORMANCE_REPORT.md)).
