...
- Detalle en [SHIFT.md](../reference/SHIFT.md) / `STATE_MACHINE.md` (fases siguientes).
...
- No hay una entidad `Match` única: el match es la conjunción postulación +
  asignación + confirmación. Ver [MATCHING.md](../reference/MATCHING.md) (Fase 2).
...
- **No es una entidad.** La ubicación se maneja como **ciudad/barrio + lat/lng**:
  ...
  - Detalle en [LOCATION.md](../reference/LOCATION.md) (Fase 2).
