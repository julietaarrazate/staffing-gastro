...
> [TECH_DEBT.md](./TECH_DEBT.md). Contexto en [PRODUCT.md](./PRODUCT.md),
> [DOMAIN.md](./DOMAIN.md), [ARCHITECTURE.md](./ARCHITECTURE.md).
...
- **Ciclo de vida post-match:** `app/my-shifts/page.tsx:140-172` expone **6
  ...
  [MAPS_REDESIGN.md](./MAPS_REDESIGN.md) §4.4, hoy no implementado). Es
...
- **Pago:** `mark-paid` es un botón que cambia estado, no cobra
  ...
  documentado en [PAYMENTS.md](./PAYMENTS.md), sin sorpresas para el usuario
...
[RECOMMENDATIONS.md](./RECOMMENDATIONS.md) señalaba: "Admin sin migrar".
...
- **Rediseño propuesto:** [MAPS_REDESIGN.md](./MAPS_REDESIGN.md) — documento
...
- **Backups/rollback:** no documentados. `render.yaml` no define política de
  ...
  nativas de Render/Vercel (no hay guía en `docs/DEPLOY.md` sobre cómo
  ejecutarlo).
