...
> [`docs/PERFORMANCE_REPORT.md`](../docs/PERFORMANCE_REPORT.md) (backend +
> DB + frontend, con 3 rondas de actualización, la última del
> `claude/performance` batch) y
> [`docs/PERFORMANCE_AUDIT_FRONTEND.md`](../docs/PERFORMANCE_AUDIT_FRONTEND.md)
...
- `docs/DATABASE.md` sigue sin corregir la afirmación "sin índices
...
- `docs/SCALABILITY_REPORT.md` (no repetido en detalle en esta fase, es
  ...
  `docs/ARCHITECTURE.md`: la infraestructura cambió más rápido que los
