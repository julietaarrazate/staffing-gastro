...
class RefreshSessionModel(Base):
    """Tabla `refresh_sessions`: whitelist de refresh tokens vivos (R1.2, ADR-0002)."""
...
class EmailVerificationTokenModel(Base):
    """Tabla `email_verification_tokens`: tokens de un solo uso para
    confirmar la propiedad del email al registrarse (PRODUCTION_HARDENING.md).
    Mismo diseño que `PasswordResetTokenModel`: sólo se guarda el hash."""
