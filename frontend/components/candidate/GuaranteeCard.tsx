...
/**
 * "Garantía Staffya": le pone palabras a mecanismos que ya existen (no-show
...
const POINTS = [
  ...
  "Puntualidad y reseñas reales, derivadas de turnos hechos en Staffya (no autodeclaradas).",
