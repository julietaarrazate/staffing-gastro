        ...
        <nav className="flex items-center gap-4 text-sm font-medium">
          ...
          {!loading && !user && (
            <>
              ...
              <Link
                href="/register"
                className="rounded-[var(--radius-btn)] bg-primary px-3.5 py-1.5 text-night shadow-[0_8px_20px_rgba(249,78,27,0.28)] transition active:scale-95 hover:brightness-[1.04]"
              >
                Crear cuenta
              </Link>
            </>
