    ...
    <div className="flex h-full flex-1 flex-col px-4 py-4">
      ...
      <form onSubmit={send} className="mt-3 flex gap-2">
        ...
        <button
          ...
          className="flex min-h-[44px] items-center justify-center rounded-[var(--radius-btn)] bg-primary px-5 text-sm font-semibold text-white hover:bg-primary-strong disabled:opacity-50"
        >
          Enviar
        </button>
      </form>
