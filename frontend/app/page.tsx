          ...
          >
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link
                ...
                className="rounded-[var(--radius-btn)] bg-primary px-7 py-3.5 font-semibold text-ink shadow-[0_8px_20px_rgba(249,115,22,0.28)] transition active:scale-95 hover:brightness-[1.04]"
              >
                Necesito personal
              </Link>
              <Link
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Reveal className="sm:col-span-2">
              <ParallaxCard range={PARALLAX_RANGES[0]}>
                <motion.div
                  whileHover={{ y: -4 }}
                  className="flex h-full flex-col justify-between rounded-[var(--radius-card)] bg-primary p-6 text-ink shadow-[0_8px_20px_rgba(249,115,22,0.28)] transition"
                >
